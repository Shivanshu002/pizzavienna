                    ...
                    <div className='flex gap-10 pl-2 pr-2'>
                        <div className='w-1/2'>
                            <div>
                                <div className='flex justify-between items-center'>
                                    ...
                                    <div className='price-box '>
                                        <div>
                                            <i className='text-[22px] text-[#FFD700] font-cooperBlack '>Small</i>
                                        ...
                                        <div>
                                            <i className='text-[22px] text-[#FFD700] font-cooperBlack '>Large</i>
                                            <p className='pizza-price '>////</p>
                                        </div>

                                        <div>
                                            <i className='text-[22px]  font-cooperBlack text-[#FFD700] '>XLarge</i>
                                            <p className='pizza-price '>////</p>
                                        </div>

                                    </div>
                                </div>
                                <p className='discription-text'> Only medium size. Pick your own toppings</p>
                            </div>
                            ...
                            <div className=''>
                                ...
                                <p className='discription-text'>Wood-Fired brick oven, daily prepared fresh dough and sauce in house</p>
                            ...
                            <div className=''>
                                ...
                                <p className='discription-text'>Tomato sauce, pinapple cubes, cheese and ham</p>
                            </div>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Bbq sauce, cheese, green peppers, mushroom, tomatoes, olives, onions, chicken.</p>
                            </div>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>White sauce, mushroom, onions, green pepper, steak, cheese</p>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Red sauce, cheese, pepproni, sausage, meatball, mushroom, green pepper, onions</p>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Alfredo sauce, chiken, brocoli, mushroom</p>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Red sauce or marinara sauce, mozzarella cheese, basil, olive oil and parmesan cheese</p>
                            </div>
                        </div>
                        ...
                        <div className='w-1/2 pr-2'>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Alfredo sauce, broccoli, mushroom, spinach, diced tomato, scallion</p>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Crispy chicken, bacon, ranch dressing & mozzarella cheese.</p>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Mushroom, roasted red pepper, eggplant, spinach, mozzarella cheese and red sauce</p>
                            </div>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Marinara sauce, eggplant, basil, parmesan, ricotta & mozzarella chesse</p>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Tzatziki sauce, eggplant, basil, spinach, onion, tomato, black, olives, feta, cheese</p>
                            ...
                            <div >
                                ...
                                <p className='discription-text'>Masala marinated chicken, green pepper, onion</p>
